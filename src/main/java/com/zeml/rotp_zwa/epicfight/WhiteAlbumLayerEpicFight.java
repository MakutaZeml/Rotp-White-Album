...
public class WhiteAlbumLayerEpicFight  <E extends LivingEntity, T extends LivingEntityPatch<E>, M extends BipedModel<E>> extends PatchedLayer<E, T, M, WhiteAlbumLayer<E, M>> {
    public static ResourceLocation WHITE_ALBUM = new  ResourceLocation(RotpWhiteAlbumAddon.MOD_ID,"/textures/entity/stand/white_album.png");

    @Override
    public void renderLayer(T t, E e, WhiteAlbumLayer<E, M> emWhiteAlbumLayer, MatrixStack matrixStack, IRenderTypeBuffer iRenderTypeBuffer, int i, OpenMatrix4f[] openMatrix4fs, float v, float v1, float v2) {
